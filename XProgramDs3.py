...
# sensor data
X_train = pd.read_csv('C:\\D Drive\\PythonTest\\Test4Cnn\\WorkingDatasets\\3\\UCI HAR Dataset\\train\\X_train.txt', sep='\s+', header=None)
X_test = pd.read_csv('C:\\D Drive\\PythonTest\\Test4Cnn\\WorkingDatasets\\3\\UCI HAR Dataset\\test\\X_test.txt', sep='\s+', header=None)


# sensor labels
sensor_labels = pd.read_csv('C:\\D Drive\\PythonTest\\Test4Cnn\\WorkingDatasets\\3\\UCI HAR Dataset\\features.txt', sep=' ', header=None, names=('ID','Sensor'))

# activity class
y_train = pd.read_csv('C:\\D Drive\\PythonTest\\Test4Cnn\\WorkingDatasets\\3\\UCI HAR Dataset\\train\\y_train.txt', sep='\s+', header=None, names=['Y'])
y_test = pd.read_csv('C:\\D Drive\\PythonTest\\Test4Cnn\\WorkingDatasets\\3\\UCI HAR Dataset\\test\\y_test.txt', sep='\s+', header=None, names=['Y'])

# activity labels
activity_labels = pd.read_csv('C:\\D Drive\\PythonTest\\Test4Cnn\\WorkingDatasets\\3\\UCI HAR Dataset\\activity_labels.txt', sep=' ', header=None, names=('ID','Activity'))
...
# #history = model.fit(X_train, y_train, epochs = 17, validation_data= (X_test, y_test), verbose=1)
history = model.fit(X_train, y_train['Y'], epochs = 25, validation_split=0.2, verbose=1)
